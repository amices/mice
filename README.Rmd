...
See [MICE: Multivariate Imputation by Chained Equations](https://amices.github.io/mice/) 
for more resources.
...
Please note that the mice project is released with a [Contributor Code of Conduct](https://amices.github.io/mice/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
