...
The method is based on Fully Conditional Specification (Van Buuren 2007), where 
an imputation model for each incomplete variable is created. The MICE algorithm
