...
`mice 3.8.0` removes dependencies, and does not automatically install anymore the `jomo` package. I have alerted the `miceadds` package maintainer, and asked for a fix (which is simple).
