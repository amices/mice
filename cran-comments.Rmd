...
I believe that these errors are due to the win-builder library. I am afraid I cannot solve these.
...
I believe these files are always produced by the builder, and do not indicate
package failures.
