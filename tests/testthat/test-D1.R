...
test_that("D1: compares fit1 to the intercept-only model", {
...
test_that("D1: compares fit1 to empty model", {
...
test_that("D2: compares fit1 to the intercept-only model", {
  expect_identical(z1$result, z2$test)
  expect_identical(z1$test, z3$test)
})
...
test_that("D2: compares fit1 to empty model", {
  expect_identical(z4$result, z5$test)
})
