...
```{r, include = FALSE}
bwplot1 <- bwplot(result, which.pat = 1)
png(filename="bwplot1.png", 
    type="cairo",
    units="in", 
    width=4, 
    height=3, 
...
bwplot1
dev.off()
bwplot2 <- bwplot(result, which.pat = 3)
png(filename="bwplot2.png", 
    type="cairo",
    units="in", 
    width=4, 
    height=3, 
...
\includegraphics[width=\linewidth]{bwplot1.png}
\end{subfigure}
\begin{subfigure}{0.75\textwidth}
\includegraphics[width=\linewidth]{bwplot2.png}
\end{subfigure}
\end{figure}
...
```{r, include = FALSE}
xyplot1 <- xyplot(result, which.pat = 1)
png(filename="xyplot1.png", 
    type="cairo",
    units="in", 
    width=5.5, 
    height=4.5, 
...
\begin{figure}[h!]
\includegraphics[width=\linewidth]{xyplot1.png}
\end{figure}
...
\begin{figure}[t!]
  ...
  \captionsetup{justification=raggedright,
singlelinecheck=false}
  \caption{Adaptations of continuous logit functions}
  \label{fig2}
\end{figure}

The logit functions are more thoroughly explained by Van Buuren (2012, pp. 63, 64), but a quick overview will be given here. Four missingness functions are known: RIGHT, MID, TAIL and LEFT missingness. Figure \ref{fig2} shows the course of the probabilities for standardized values. 
...
```{r, include = FALSE}
bwplot3 <- bwplot(result, which.pat = 2)
png(filename="bwplot3.png", 
    type="cairo",
    units="in", 
    width=4, 
    height=3, 
...
\begin{figure}[h!]
\includegraphics[width=\linewidth]{bwplot3.png}
\end{figure}
...
```{r, include = FALSE}
xyplot2 <-xyplot(result, which.pat = 4)
png(filename="xyplot2.png", 
    type="cairo",
    units="in", 
    width=5.5, 
    height=4.5, 
...
\begin{figure}[h!]
\includegraphics[width=\linewidth]{xyplot2.png}
\end{figure}
...
\begin{figure}[t!]
  ...
  \captionsetup{justification=raggedright,
singlelinecheck=false}
  \caption{Division of odds groups over variables $V_2$ and $V_3$}
  \label{fig4}
\end{figure}
...
```{r, include = FALSE}
bwplot4 <- bwplot(result, which.pat = 3)
png(filename="bwplot4.png", 
    type="cairo",
    units="in", 
    width=4, 
    height=3, 
...
bwplot4
dev.off()
bwplot5 <- bwplot(result, which.pat = 4)
png(filename="bwplot5.png", 
    type="cairo",
    units="in", 
    width=4, 
    height=3, 
...
\begin{figure}[h!]
\includegraphics[width=\linewidth]{bwplot4.png}
\end{figure}

\begin{figure}[h!]
\includegraphics[width=\linewidth]{bwplot5.png}
\end{figure}
