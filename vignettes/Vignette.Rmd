...
The return object is of class `mads` (Multivariate Amputed Data Set) and contains the information about the amputation. In total, the object contains the following:
