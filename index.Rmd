...
1. [Article](https://www.jstatsoft.org/v45/i03/paper) in the Journal of Statistical Software [@vanbuuren2011a]. 
...
4. Details about imputing [mixes of numerical and categorical data](http://www.stefvanbuuren.nl/publications/MI%20by%20FCS%20-%20SMMR%202007.pdf) can be found in [@vanbuuren2007a]. 
5. [Wulff and Ejlskov](http://www.ejbrm.com/issue/download.html?idArticle=450 ) provide a comprehensive overview of MICE. 
6. Many more details and applications can be found in the book *Flexible Imputation of Missing Data* [@vanbuuren2012] (see [Chapman \& Hall/CRC](https://www.crcpress.com/Flexible-Imputation-of-Missing-Data/van-Buuren/p/book/9781439868249) or 
