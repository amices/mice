...
<title>Imputation by linear regression without parameter uncertainty — mice.impute.norm.nob • mice</title>
...
<meta property="og:title" content="Imputation by linear regression without parameter uncertainty — mice.impute.norm.nob" />

<meta property="og:description" content="Imputes univariate missing data using linear regression analysis without 
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Imputation by linear regression without parameter uncertainty</h1>
    
    <div class="hidden name"><code>mice.impute.norm.nob.rd</code></div>
    </div>

    <div class="ref-description">
    
    <p>Imputes univariate missing data using linear regression analysis without 
accounting for the uncertainty of the model parameters.</p>
    
    </div>

    <pre class="usage"><span class='fu'><a href='mice.impute.norm.nob.rd.html'>mice.impute.norm.nob</a></span>(<span class='no'>y</span>, <span class='no'>ry</span>, <span class='no'>x</span>, <span class='kw'>wy</span> <span class='kw'>=</span> <span class='kw'>NULL</span>, <span class='no'>...</span>)</pre>
...
<code>mice.impute.norm.nob</code>.</p>
...
samples, variability of the imputed data is therefore underestimated.</p>
...
Ph.D. Thesis, TNO Prevention and Health/Erasmus University Rotterdam.</p>
    
    <h2 class="hasAnchor" id="see-also"><a class="anchor" href="#see-also"></a>See also</h2>

    <div class='dont-index'><p><code><a href='mice.html'>mice</a></code>, <code><a href='mice.impute.norm.html'>mice.impute.norm</a></code></p>
<p>Other univariate imputation functions: <code><a href='mice.impute.cart.html'>mice.impute.cart</a></code>,
  ...
  <code><a href='mice.impute.pmm.html'>mice.impute.pmm</a></code>,
  ...
  <div class="col-md-3 hidden-xs hidden-sm" id="sidebar">
    ...
    <h2>Author</h2>
    <p>Gerko Vink, Stef van Buuren, Karin Groothuis-Oudshoorn, 2018</p>
  </div>
</div>
