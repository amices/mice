...
<title>Project on preterm and small for gestational age infants (POPS) — pops • mice</title>
...
<meta property="og:title" content="Project on preterm and small for gestational age infants (POPS) — pops" />

<meta property="og:description" content="Subset of data from the POPS study, a national, prospective study on preterm
...
<div class="row">
  <div class="col-md-9 contents">
    ...
    <h1>Project on preterm and small for gestational age infants (POPS)</h1>
    
    <div class="hidden name"><code>pops.rd</code></div>
    </div>
...
the multiple imputation model.</p>
...
19-year-old adolescents born as preterm infants. Pediatrics, 116(5):662666.</p>
...
gestational age infants at 19 years of age. Pediatrics, 120(3):587595.</p>
<p>Van Buuren, S. (2018). 
...
mailed requests or telephone calls, or could not be traced, n = 254).</p>
...
selective subgroup in the total cohort.</p>
<p>Multiple imputation of this data set has been described in Hille et al (2007)
and Van Buuren (2012), chapter 8.</p>
    

    <h2 class="hasAnchor" id="examples"><a class="anchor" href="#examples"></a>Examples</h2>
    <pre class="examples"><div class='input'>

<span class='no'>pops</span> <span class='kw'>&lt;-</span> <span class='fu'><a href='https://www.rdocumentation.org/packages/utils/topics/data'>data</a></span>(<span class='no'>pops</span>)</div></pre>
  </div>
