...
#' set', typically created by a call to function `mice()`.
#' @param \dots Additional parameters passed to [lm()]
#' @return An objects of class `mira`, which stands for 'multiply imputed
#' repeated analysis'.  This object contains `data$m` distinct
#' `lm.objects`, plus some descriptive information.
#' @author Stef van Buuren, Karin Groothuis-Oudshoorn, 2000
#' @seealso [lm()], [`mids()`][mids-class], [`mira()`][mira-class]
...
#' @param \dots Additional parameters passed to [glm()].
#' @return An objects of class `mira`, which stands for 'multiply imputed
#' repeated analysis'.  This object contains `data$m` distinct
#' `glm.objects`, plus some descriptive information.
#' @author Stef van Buuren, Karin Groothuis-Oudshoorn, 2000
#' @seealso [with.mids()], [glm()], [`mids()`][mids-class],
#' [`mira()`][mira-class]
