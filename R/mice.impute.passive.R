...
#' @param func A `formula` specifying the transformations on data
#' @return The result of applying `formula`
#' @details
#' Passive imputation is a special internal imputation function.  Using this
#' facility, the user can specify, at any point in the `mice` Gibbs
...
#' `Q = W/H^2` based on two variables, or a mean variable like
#' `(x_1+x_2+x_3)/3`. The so derived variables might be used in other
