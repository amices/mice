...
#'\item{\code{minority}}{Minority member 0/1}
#'\item{\code{repeatgr}}{Number of repeated classes, 0, 1, 2}
...
#'\item{\code{denomina}}{Denomination classification 1-4 - at school level}
