...
#' @name leiden85
#' @docType data
#' @format `leiden85` is a data frame with 956 rows and 336 columns.
#' @source
#'
...
#' 85 and over. *Brit. Med. J.*, *304*(6834), 1091-1092.
#'
...
#' in community residents aged 85 and older.  *Journal of the American
#' Geriatrics Society*, *45*(1), 56-60.
#'
...
#' based study.  *Brit. Med. J.*, *316*(7147), 1780-1784.
#'
...
#'
#' Van Buuren, S. (2018).
#' [*Flexible Imputation of Missing Data. Second Edition.*](https://stefvanbuuren.name/fimd/sec-toomany.html#sec:leiden85cohort)
