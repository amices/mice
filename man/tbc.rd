...
Wouwe, J. P., van Buuren, S., de Jonge, G. A., Hirasing, R.
A. (2008). Identifying metabolic syndrome without blood
tests in young adults - The Terneuzen birth cohort.
...
\description{
Data of subset of the Terneuzen Birth Cohort data on child
growth.
}
\details{
This \code{tbc} data set is a random subset of persons from
a much larger collection of data from the Terneuzen Birth
Cohort. The total cohort comprises of 2604 unique persons,
whereas the subset in \code{tbc} covers 306 persons. The
\code{tbc.target} is an auxiliary data set containing two
outcomes at adult age. For more details, see De Kroon et al
(2008, 2010, 2011).  The imputation methodology is
explained in Chapter 9 of Van Buuren (2012).
}
\examples{
data <- tbc
md.pattern(data)
