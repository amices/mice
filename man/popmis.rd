...
\source{
  Hox, J. J. (2002) \emph{Multilevel analysis. Techniques
  and applications.} Mahwah, NJ: Lawrence Erlbaum.
}
\description{
  Hox pupil popularity data with some missing popularity
  scores
}
\details{
  The original, complete dataset was generated by Joop Hox
  as an example of well-behaved multilevel data set. The
  distributed data contains missing data in pupil
  popularity.
}
\examples{
popmis[1:3,]
