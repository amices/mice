...
\format{
  \describe{
	\item{\code{pattern1}}{Data with a univariate missing data pattern}
	\item{\code{pattern2}}{Data with a monotone missing data pattern}
	\item{\code{pattern3}}{Data with a file matching missing data pattern}
	\item{\code{pattern4}}{Data with a general missing data pattern}
  }
} 
\details{
