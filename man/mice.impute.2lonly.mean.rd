...
\description{Imputes the mean of within the class}
\arguments{
  ...
  \item{type}{Vector of length \code{ncol(x)} identifying random and class variables. 
      The class variable (only one is allowed) is coded as '-2'. }
...
\details{
    Observed values in \code{y} are averaged within the class, and replicated to the 
    missing \code{y} within that class. If there are no observed data in the class, all 
    entries of the class are set to \code{NaN}.
    This function is primarily useful for repairing incomplete data that are constant 
    within the class, but that vary over the classes.  
}
